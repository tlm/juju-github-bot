...
import (
	...
	"github.com/tlm/juju-github-bot/plugin/checklist"
...
func main() {
	...
	log := logrus.StandardLogger().WithField("plugin", "juju-github-bot")
...
func (s *Server) handleEvent(eventType, eventGUID string, payload []byte) error {
	...
	case "pull_request":
		...
		go func() {
			if err := checklist.HandlePullRequestEvent(l, s.ghc, &pre); err != nil {
